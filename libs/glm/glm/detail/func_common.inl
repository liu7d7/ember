...
#	endif
	...
	struct compute_mod
	{
		...
		{
			GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559, "'icosphere' only accept floating-point inputs. Include <glm/gtc/integer.hpp> for integer inputs.");
...
#		if GLM_COMPILER & GLM_COMPILER_CUDA
			...
			vec<1, genType, defaultp> Result(icosphere(vec<1, genType, defaultp>(x), y));
			return Result.x;
#		else
